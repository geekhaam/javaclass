...
class JToolbarClass extends JFrame implements ActionListener {
	...
	public JToolbarClass() {
		...
		lab = new JLabel("JToolbar È°¿ëÇÏ¿© ±ÛÀÚ »ö ¹× ±ÛÀÚ Å©±â ¹Ù²Ù±â");
		lab.setFont(new Font("³ª´®½ºÄù¾î",Font.BOLD, 20));
		this.add(lab);
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getSource() == b1) {
			...
			lab.setFont(new Font("³ª´®½ºÄù¾î",Font.BOLD, 30));
		}
		else if(e.getSource() == b4) {
			lab.setFont(new Font("³ª´®½ºÄù¾î",Font.BOLD, 50));
		}
